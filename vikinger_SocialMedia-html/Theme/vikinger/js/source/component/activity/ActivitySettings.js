    ...
    <div className="widget-box-settings">
      <div className="post-settings-wrap">
        ...
        <div ref={settingsDropdownContentRef} className="simple-dropdown">
          ...
          {
            !props.activityIsPrivate && props.userActivityPermissions.make_private &&
              <div className="simple-dropdown-link" onClick={props.makeActivityPrivate}>{vikinger_translation.make_private} {props.processingPrivate && <LoaderSpinnerSmall />}</div>
          }
          {
