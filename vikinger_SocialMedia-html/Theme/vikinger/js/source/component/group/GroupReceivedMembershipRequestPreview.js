...
function GroupReceivedMembershipRequestPreview(props) {
  ...
  const friendCountText = props.data.user.stats.friend_count === 1 ? vikinger_translation.friend : vikinger_translation.friends;
  const commentCountText = props.data.user.stats.comment_count === 1 ? vikinger_translation.comment : vikinger_translation.comments;

  const displayVerified = vikinger_constants.plugin_active['bp-verified-member'];
      ...
      <div className="user-preview-info">
        ...
        <div className="user-short-description small">
          ...
          <p className="user-short-description-title">
            <a href={props.data.user.link}>{props.data.user.name}</a>
          {
          ...
          <p className="user-short-description-text">
            <a href={props.data.user.link}>&#64;{props.data.user.mention_name}</a>
          {
