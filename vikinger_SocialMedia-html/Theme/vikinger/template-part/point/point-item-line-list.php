...
<?php foreach ($args['points'] as $point) : ?>
  ...
  <div class="point-item-line">
    ...
    <div class="point-item-line-info">
      ...
      <p class="point-item-line-title"><?php echo esc_html(apply_filters('vikinger_points_amount_display', $point['points'], $point['id'])); ?> <?php echo esc_html($point['plural_name']); ?></p>
      <!-- /POINT ITEM LINE TITLE -->
