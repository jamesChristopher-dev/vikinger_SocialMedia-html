		...
		<?php if ( bp_account_was_activated() ) : ?>
			...
			<?php else : ?>
				<p>
					...
					printf( __( 'Your account was activated successfully! You can now <a href="%s">log in</a> with the username and password you provided when you signed up.', 'vikinger' ), wp_login_url( bp_get_root_url() ) );
					?>
				</p>
			<?php endif; ?>
